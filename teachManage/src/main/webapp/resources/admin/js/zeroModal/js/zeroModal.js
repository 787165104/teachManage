...
(function(obj) {
     ...
     * @type {String}
     */
    var _zero_modal_template = '<div zero-unique-container="{{unique}}" class="zeromodal-container" style="z-index:{{_tmp_last_zindex}};width:{{_width}}px;height:{{_height}}px;left:{{_left}};top:{{_top}}; padding:{{_padding}}">';
    ...
    var defaultOpt = {
        ...
        padding: '0px', // zeromodal-container 的 padding
    ...
    //TODO 临时变量, 当前页面body的overflow样式 add by pengxb
    var defaultOverflow ;
    ...
    zeroModal.show = function(opt) {
    	// add by pengxb
    	var body = $('body');
    	defaultOverflow = body.css('overflow');
    ...
    function _buildModal(opt) {
        ...
        // 获取zeromodal-container 的padding
        var _padding = opt.padding;
