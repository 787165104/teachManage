...
drawBall.prototype = {
	...
	showLi: function() {
		...
		for (var i = 0; i < items; i++) {
			var headImgPath = imgPath + "/1.png";
			if(initdatas[i]){
                headImgPath = initdatas[i].imgHttp;
			} else {
                headImgPath = initdatas[parseInt(Math.random() * totalperson)].imgHttp;
			}

			var style = "position:inherit;display: inline-block;margin:15px;";
			// this.html += "<li style='" + style + "'><img src='"+ imgPath + "/items/" + (i % 194) + ".jpg' onerror=\"this.src='" + imgPath + "/1.png'\"></li>"
            this.html += "<li style='" + style + "'><img src='"+ headImgPath + "' onerror=\"this.src='" + imgPath + "/1.png'\"></li>";
		};
