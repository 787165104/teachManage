...
<!-- 页面主题内容 -->
                	...
                	<div class="col-lg-12">
	                    <div class="ibox float-e-margins">
	                        ...
	                        <div class="ibox-content">
	                        	...
	                        	<input type="hidden" name="ids" id="ids" value="${memberId}">
	                                ...
	                                <div class="form-group"><label class="col-sm-2 control-label">我的科研成果:</label>
	                                    <div class="col-sm-10">
	                                    	<textarea rows="15" cols="40" id="projectResult" class="form-control" name="projectResult" readonly="readonly"></textarea>
	                                    </div>
	                                </div>
	...
	<script src="${res}/libs/bootstrap/js/plugins/datapicker/bootstrap-datepicker.js"></script>
	 <script src="${res}/libs/bootstrap/js/plugins/sweetalert/sweetalert.min.js"></script>
	<script src="${jsPath}/coursegroup/coursegroup/membergroupdetail.js"></script>
