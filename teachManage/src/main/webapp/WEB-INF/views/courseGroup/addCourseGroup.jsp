...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a href="" class="add_Html" id="xc">新增课程组</a></li>
					</ol>
				</div>
			</div>
										...
										<div class="panel-body">
											<div class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
													<textarea rows="15" cols="40" id="projectResult" name="projectResult" class="form-control">
													</textarea>
	...
	<script
		src="https://cdn.bootcss.com/bootstrap-select/2.0.0-beta1/js/i18n/defaults-zh_CN.js"></script>
	<script src="${jsPath}/coursegroup/coursegroup/add.js"></script>
