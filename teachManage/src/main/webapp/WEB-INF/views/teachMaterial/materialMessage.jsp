...
<div id="wrapper">
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="form-group">
							    <label class="control-label" for="courseName">课程编号</label>
							    <input type="text" id="courseNum" name="courseNum" class="form-control">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
							    <label class="control-label" for="materialName">教材名称</label>
							    <input type="text" id="materialName" name="materialName" class="form-control">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
							    <label class="control-label" for="author">第一作者</label>
							    <input type="text" id="author" name="author" class="form-control">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
							    <label class="control-label" for="orderNum">版次</label>
						...
						<div class="col-sm-3">
							<div class="form-group">
							    <label class="control-label" for="isOptional">是否选修</label>
							    <select id="isOptional" name="isOptional" class="selectpicker show-tick form-control"  data-live-search="true">
	...
	<script src="${jsPath}/teachmanage/teachmaterial/list.js"></script>
</body>
</html>