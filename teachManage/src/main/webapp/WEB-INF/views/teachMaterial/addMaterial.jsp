...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a href="" class="add_Html" id="xc">新增教材</a></li>
					</ol>
				</div>
			</div>
									...
									<div id="tab-1" class="tab-pane active">
										...
										<div class="panel-body">
											<div class="form-horizontal">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">使用年级:</label>
													<div class="col-sm-4">
															<select id="useGrade" name="useGrade"
																class="selectpicker show-tick form-control">
																<option value="">请选择</option>
															</select>
														</div>
	...
	<script src="${jsPath}/teachmanage/teachmaterial/add.js"></script>
