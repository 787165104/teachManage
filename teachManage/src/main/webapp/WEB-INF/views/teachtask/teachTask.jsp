...
<body>
					...
					<div id="query" class="ibox-content m-b-sm border-bottom">
						<form id="exportForm" action="exportTeachTask"
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label class="control-label" for="jobNumber">主讲教师</label> <input
											type="text" id="jobNumber" name="jobNumber"
											class="form-control">
									</div>
								</div>
								<div class="col-sm-3">
					...
					<div class="col-lg-12">
						<div class="ibox ">
							<div class="ibox-title">
								...
								<button class="btn btn-info" type="button" id="editButton">
	...
	<script src="${jsPath}/taskmanage/teachtask/teachtask.js"></script>
</body>
</html>