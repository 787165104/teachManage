...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="tabs-container">
							...
							<form id="updateTeachTaskForm" class="form-horizontal" method="post"
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<div class="col-sm-12" style="text-align: right;">
													...
													<button style="width: 100px;" id="updateBtn"
	...
	<script
		src="https://cdn.bootcss.com/bootstrap-select/2.0.0-beta1/js/i18n/defaults-zh_CN.js"></script>
	<script src="${jsPath}/taskmanage/teachtask/updateteachtask.js"></script>
