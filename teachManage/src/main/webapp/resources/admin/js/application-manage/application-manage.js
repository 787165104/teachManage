    ...
    $.ajax({
        ...
        success : function (rs) {
            if(rs){
                ...
                for(var i in rs){
                    ...
                    if($input.length) {
                        ...
                        if(i == 'appIcon') {
                            ...
                            if(rs.fromSource == '1' ) {
                                $('input[name="appIconName"]',p).removeAttr('style');
                            } else {
                                $('input[name="appIconName"]',p).attr('style', 'background-color: #fff !important; cursor: pointer;');
                            }
                        }
                        continue;
                    }
                ...
                if(rs.fromSource == '1' ) {
                    $('#btnEditApp').attr('disabled', 'disabled');
                    $('#btnEditApp').text('系统应用,不可编辑');

                    $('input[type="text"]', '#editAppForm').each(function () {
                       $(this).attr('disabled', 'disabled');
                    });

                    $('select', '#editAppForm').each(function () {
                       $(this).attr('disabled', 'disabled');
                    });
                } else {
                    $('#btnEditApp').removeAttr('disabled');
                    $('#btnEditApp').text('更新');
